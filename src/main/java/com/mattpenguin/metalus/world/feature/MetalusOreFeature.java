package com.mattpenguin.metalus.world.feature;
...
public class MetalusOreFeature extends Feature<OreFeatureConfig> {
    public MetalusOreFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> p_i51472_1_) {
        super(p_i51472_1_);
    }
